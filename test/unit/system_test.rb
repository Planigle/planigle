...
class SystemTest < ActiveSupport::TestCase
  ...
  def test_summarize
    ...
    Story.create(:project_id => 1, :iteration_id => iteration1.id, :name => 'a', :effort => 2, :status_code => 2)
    iteration2 = Iteration.create(:project_id =>1, :name => 'end', :start => Date.today - 13, :length => 2)
    Story.create(:project_id => 1, :iteration_id => iteration2.id, :name => 'a', :effort => 3, :status_code => 2)
    System.summarize
