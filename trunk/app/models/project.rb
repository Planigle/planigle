...
class Project < ActiveRecord::Base
  ...
  def add_default_attributes
    story_attributes << StoryAttribute.new(:name => 'Name', :is_custom => false, :value_type => StoryAttribute::String, :width => 200, :ordering => 10, :show => true)
    story_attributes << StoryAttribute.new(:name => 'Description', :is_custom => false, :value_type => StoryAttribute::Text, :width => 300, :ordering => 20, :show => false)
    story_attributes << StoryAttribute.new(:name => 'Acceptance Criteria', :is_custom => false, :value_type => StoryAttribute::Text, :width => 300, :ordering => 30, :show => false)
    story_attributes << StoryAttribute.new(:name => 'Release', :is_custom => false, :value_type => StoryAttribute::List, :width => 100, :ordering => 40, :show => false)
    story_attributes << StoryAttribute.new(:name => 'Iteration', :is_custom => false, :value_type => StoryAttribute::List, :width => 100, :ordering => 50, :show => true)
