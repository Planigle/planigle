package org.planigle.planigle.commands
{
	...
	public class UpdateTaskCommand implements ICommand, IResponder
	{
		...
		public function UpdateTaskCommand(aTask:Task, someParams:Object, aSuccessFunction:Function, aFailureFunction:Function)
		{
			task = aTask;
			params = someParams;
		...
		{
			new TasksDelegate( this ).updateTask(task, params);
		}
