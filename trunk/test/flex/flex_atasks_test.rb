...
class FlexAtasksTest < Test::Unit::TestCase
  ...
  def edit_multiple
    ...
    assert_equal '', @ie.text_area("storyError").text
    assert_equal num_rows, @ie.data_grid("storyResourceGrid").num_rows
    assert_equal ",test2_task,,Backlog,,aaron hank,,2,Not Started, , , ,, ,, , , ,, ,Edit | Delete | Move To Top | Add Task | Split", @ie.data_grid("storyResourceGrid").tabular_data(:start => 3, :end => 3)
    assert_equal ",test_task,,Backlog,,aaron hank,,3,Not Started, , , ,, ,, , , ,, ,Edit | Delete | Move To Top | Add Task | Split", @ie.data_grid("storyResourceGrid").tabular_data(:start => 4, :end => 4)
  end
...
private
  ...
  def create_task_success
    ...
    assert_equal ",foo,,Backlog,,ted williams,,1,Blocked, , , ,description, ,, , , ,, ,Edit | Delete | Move To Top | Add Task | Split", @ie.data_grid("storyResourceGrid").tabular_data(:start => 2, :end => 2)
    @ie.button("storyBtnCancel").click
  end
  ...
  def edit_task_success
    ...
    assert_nil @ie.button("storyBtnCancel")
    assert_equal num_rows, @ie.data_grid("storyResourceGrid").num_rows
    assert_equal ",foo 1,,Backlog,,ted williams,,1,Blocked, , , ,description, ,, , , ,, ,Edit | Delete | Move To Top | Add Task | Split", @ie.data_grid("storyResourceGrid").tabular_data(:start => 2, :end => 2)
  end
