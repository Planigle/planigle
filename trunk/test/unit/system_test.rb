...
class SystemTest < ActiveSupport::TestCase
  ...
  def test_summarize
    ...
    Story.create(:project_id => 1, :release_id => release1.id, :iteration_id => iteration1.id, :name => 'a', :effort => 2, :status_code => 2)
    ...
    Story.create(:project_id => 1, :release_id => release2.id, :iteration_id => iteration2.id, :name => 'a', :effort => 3, :status_code => 2)
    System.summarize
