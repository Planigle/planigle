    ...
    class AMFSerializer
      ...
      def write_amf3_date(datetime) # Aryk: Dates will almost never be the same, so turn off the storing_objects
        ...
        seconds = if datetime.is_a?(Time)
          ...
          datetime.strftime("%s").to_i + 86400 # WRB - Fix for date bug (see http://groups.google.com/group/rubyamf/browse_thread/thread/d661a6dabe1ad303/d004710b6fc38916?lnk=gst&q=date#d004710b6fc38916)
