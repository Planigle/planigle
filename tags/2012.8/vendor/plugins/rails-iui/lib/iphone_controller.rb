...
#        if is_iphone_request? || is_iphone_format? || is_iphone_subdomain?  # WRB - Changed since this caused it to always use the iphone format
        if is_iphone_request? || is_iphone_subdomain?
