...
module RubyAMF
  module Configuration
    ...
    ClassMappings.register(
      ...
      :ruby => 'Iteration',
      :type => 'active_record',
      :attributes => ["id", "project_id", "name", "start", "finish", "retrospective_results", "notable"],
      :methods => ['updated_at_string'])
    ...
    ClassMappings.register(
      ...
      :ruby => 'Individual',
      :type => 'active_record',
      :attributes => ["id", "company_id", "login", "email", "first_name", "last_name", "activated_at", "enabled", "accepted_agreement", "last_login", "role", "team_id", "phone_number", "notification_type", "refresh_interval"],
    ...
    ClassMappings.register(
      ...
      :ruby => 'Story',
      :type => 'active_record',
      :attributes => ["id", "project_id", "story_id", "name", "description", "release_id", "iteration_id", "individual_id", "effort", "status_code", "priority", "user_priority", "is_public", "team_id", "reason_blocked"],
      :methods => ["acceptance_criteria", "updated_at_string", "filtered_stories", "filtered_tasks", "epic_name", "lead_time", "cycle_time"],
      :associations => ["story_values", "criteria"])
    ...
    ClassMappings.register(
      ...
      :methods => ["updated_at_string", "lead_time", "cycle_time"])
    ...
    ClassMappings.register(
      ...
      :ruby => 'CategoryTotal',
      :type => 'custom',
      :attributes => ["id", "team_id" "story_attribute_id", "category", "total"])

    ClassMappings.register(
      :actionscript => 'IterationVelocity',
      :ruby => 'IterationVelocity',
      :type => 'active_record',
      :attributes => ["id", "iteration_id", "team_id", "attempted", "completed", "lead_time", "cycle_time", "num_stories"])
    ...
    ClassMappings.register(
      ...
      :ruby => 'StoryAttribute',
      :type => 'active_record',
      :attributes => ["id", "project_id", "name", "value_type", "is_custom", "width", "ordering", "show"],
    ...
    ClassMappings.register(
      ...
      :ruby => 'Audit',
      :type => 'active_record',
      :attributes => ["id", "project_id", "auditable_type", "auditable_id", "auditable_name", "user_id", "action", "changes", "created_at"])

    ClassMappings.register(
      :actionscript => 'Error',
      :ruby => 'Error',
      :type => 'active_record',
      :attributes => ["message", "stack_trace"])
